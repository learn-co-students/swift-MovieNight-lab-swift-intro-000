...
final class Movie {
    ...
    init(movieJSON: [String: String]){
        ...
        self.year = movieJSON["Year"] ?? "Unknown"
        self.imdbID = movieJSON["imdbID"] ?? "Unavailable"
    ...
    func updateFilmInfo(_ jsonResponse: [String: String]){
        ...
        self.rated = jsonResponse["Rated"] ?? self.rated
        self.released = jsonResponse["Released"] ?? self.released
        self.director = jsonResponse["Director"] ?? self.director
        self.imdbRating = jsonResponse["imdbRating"] ?? self.imdbRating
        self.tomatoMeter = jsonResponse["tomatoMeter"] ?? self.tomatoMeter
        self.plot = jsonResponse["Plot"] ?? self.plot
