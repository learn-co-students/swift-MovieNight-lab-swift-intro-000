...
final class Movie {
    ...
    var release: String = "No Release Date"
    ...
    init(movieJSON: [String: String]) {
        ...
        self.imdbID = movieJSON["imdbID"] ?? "No IMDB ID"
        self.posterURLString = movieJSON["Poster"] ?? nil
    }
    ...
    func updateFilmInfo(_ jsonResponse: [String: String]) {
        ...
        self.rated = jsonResponse["Rated"] ?? "Not Rated"
        self.release = jsonResponse["Released"] ?? "No Release Date"
